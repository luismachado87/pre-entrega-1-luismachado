...
const Cart = () =>{
    ...
    return (
        ...
        <div className="row justify-content-center">
            ...
            <div className="col-automs-auto">
                <h2>valor total: $ {cartTotal}</h2>
                </div>      
                <div className="col-auto">
                    <button className="btn btn-danger m-2" onClick={() => emptyCart()}>vaciar carro</button>
                    <button className="btn btn-primary m-2" >pagar</button>
